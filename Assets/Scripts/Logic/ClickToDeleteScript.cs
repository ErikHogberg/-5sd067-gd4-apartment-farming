...
public class ClickToDeleteScript : MonoBehaviour {
	...
	[Tooltip("[Not used of Spawned By Click Script is true] Should be set to the top-most parent object that will be deleted, setting this to the wrong object might fill the scene with garbage clone objects")]
